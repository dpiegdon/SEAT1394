...
ringbuffer via DMA.  Once the ReaderThread sees that the ringbuffer is not
...
then write it into the \emph{ToMaster} ringbuffer, so the master can read it via
DMA.
...
\begin{figure}[ht] \begin{center}
	...
	\end{lstlisting}
	\caption{Beachhead shellcode, pseudocode}
