...
Several advances in hacking via DMA will be introduced; attacks to steal ssh
private keys, inject code and obtain an interactive shell via firewire only will
be presented.
...
system and hardware combinations, but as a sample target, Linux on an IA-32
